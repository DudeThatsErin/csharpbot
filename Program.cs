...
namespace CSharpBot
{
    ...
    {
        public static Task Main(string[] args) => new CSharpClass().MainAsync();
        ...
        public async Task MainAsync()
        {
            ...
            string? token = JsonConvert.DeserializeObject<AConfigurationClass>(File.ReadAllText("bot_info.json"))!.Token;
